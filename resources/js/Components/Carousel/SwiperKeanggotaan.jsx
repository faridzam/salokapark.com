...
import {certification} from '../../assets/images/certification';
import Grid from '@mui/material/Unstable_Grid2'; // Grid version 2
import {useMediaQuery, Box, Typography} from '@mui/material';
import { useTheme } from "@mui/material/styles";
import {ArrowForward, ArrowForwardIos, ArrowBackIos} from '@mui/icons-material';
import customStyle from "./swiperKeanggotaan.module.css";
...
export default function App(props) {
    ...
    const SLIDE_COUNT = certification.length;
                                ...
                                sx={{
                                    ...
                                    sx={{
                                        ...
                                        sx={{
                                            ...
                                            >{certification[index].title}</Typography>
                                        </Box>
                                        <Box
                                        sx={{
                                            marginTop: '10px',
                                            ...
                                            >{certification[index].description}</Typography>
                                        </Box>
                                    </Box>
                                </Grid>
                            </SwiperSlide>
