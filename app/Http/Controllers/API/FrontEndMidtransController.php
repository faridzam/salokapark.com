    ...
    public function midtransNotificationHandler(Request $request) {
        ...
        if ($transaction == 'capture') {
            ...
            if ($type == 'credit_card'){
                ...
                $bookingCode = date('Ymd', strtotime( $arrival_date->arrival_date )).$reservationData->customer_id.$reservationData->payment_method_id.$reservationData->reservation_option_id.$reservationData->id;
                $reservation = reservation::where('order_id', $order_id)
                ->update([
